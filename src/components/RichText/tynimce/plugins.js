...
const plugins = [
  ...
  // 'autoresize ', // 开启之后设置height 无效 编辑器大小自适应 - 该插件提供自动调整编辑器大小的方法以适应内容
  ...
  'emoticons', // 表情插件
  // 'fullpage', // 不用 文档属性 编辑元数据和文档属性，包含title，keywords，description和文档编码charset。
  'fullscreen', // 全屏
  'help', // 帮助
  'image', // 插入编辑图片
  'importcss', // 引入css
  ...
  'noneditable', // 不可编辑元素
  'pagebreak', // 插入分页符
  'paste', // 强大 粘贴插件 此插件将过滤/清除从Word粘贴过来的内容。它的强大之处在于它提供的强大配置，所以请花点时间将本页所有内容阅读完。
  'quickbars', // 快速工具栏
